...
export function ReferClient() {
  ...
  const brandName = "MyListings"; // Fallback for static rendering
    ...
    <div className="min-h-screen bg-white">
      ...
      <section className="pt-32 sm:pt-48 pb-20 px-4 sm:px-6 text-center">
        <motion.div initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} transition={{ duration: 0.5 }} className="mx-auto max-w-2xl">
          <span className="inline-block px-4 py-1.5 rounded-full bg-blue-50 text-brand-primary ty-micro font-black tracking-widest uppercase mb-6">Any Type Property</span>
          <h1 className="ty-hero font-black tracking-tighter text-zinc-900 uppercase leading-[0.9] mb-6">
            Anyone Buying <br /> <span className="text-brand-primary">or Selling</span> <span className="text-zinc-400">Property?</span>
          </h1>
          <p className="ty-display font-black text-zinc-900 uppercase tracking-tighter mb-4">Share Details & Earn up to ₹25 Lakhs.</p>
      ...
      <section className="py-20 px-4 sm:px-6 bg-zinc-900 text-white rounded-[48px] mx-4 sm:mx-10 mb-10 relative overflow-hidden">
        <div className="mx-auto max-w-5xl relative z-10 text-center">
          ...
          <h2 className="ty-hero font-black tracking-tighter text-white uppercase mb-3 leading-[0.9]">₹25,000 – ₹25 Lakh</h2>
      ...
      <section className="py-24 px-4 sm:px-6 bg-zinc-50 border-y border-zinc-100">
        <div className="mx-auto max-w-5xl">
          <div className="text-center mb-16"><h2 className="ty-display font-black text-zinc-900 uppercase tracking-tighter">How it Works</h2></div>
            ...
            {[
              ...
              <div key={i} className="flex flex-col items-center text-center relative z-10">
                <div className="mb-6 flex h-24 w-24 items-center justify-center rounded-[28px] bg-white border border-zinc-100 shadow-xl shadow-zinc-200/50 relative">
                  ...
                  <span className="absolute -top-2 -right-2 h-6 w-6 rounded-full bg-brand-primary text-white text-[9px] font-black flex items-center justify-center"><CheckCircle2 className="h-3.5 w-3.5" /></span>
                </div>
      ...
      <footer className="py-10 border-t border-zinc-100 text-center">
        <p className="ty-micro font-bold text-zinc-400 uppercase tracking-[0.2em]">{brandName} Referral Program &copy; 2026</p>
      </footer>
    </div>
  );
}
