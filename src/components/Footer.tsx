...
function ClearDataButton() {
  const handleClearData = () => {
    const ok = window.confirm('Clear all saved data and cookies? This will reset your preferences and shortlists.');
    if (!ok) return;
    localStorage.clear();
  ...
  return (
    <button
      ...
      className="ty-caption font-bold text-rose-400 hover:text-rose-600 transition-colors flex items-center gap-1.5"
    >
    ...
    <footer className="bg-zinc-50 border-t border-zinc-200 pt-16 pb-8">
      <div className="mx-auto max-w-[1440px] px-4 sm:px-6 lg:px-12">
        <div className="grid gap-12 md:grid-cols-4 mb-20">
          ...
          <div>
            <h4 className="ty-label text-zinc-900 mb-6">Other</h4>
            <ul className="space-y-4">
        ...
        <div className="pt-8 border-t border-zinc-200 flex flex-col md:flex-row justify-between items-center ty-label text-zinc-400">
